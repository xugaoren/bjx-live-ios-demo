...
@property (nonatomic, strong)NSString *leftOrRight;//left 左silder wifi窗帘双向左部

@property (nonatomic, strong)NSString *showNum;//yes no

@property (nonatomic, strong)NSString *Numvertical;//yes no
